...
import { X, Save, ArrowLeft, ImageIcon } from "lucide-react"
...
export default function AddProductPage() {
  ...
  const onSubmit = async (data: ProductFormData) => {
    ...
    try {
      const productData = {
        ...data,
        images: images.length > 0 ? images : ["/placeholder.svg?height=600&width=600"],
      }
      ...
      if (result.success) {
        toast({
          ...
          description: "Your product has been added to the catalog and is now visible on the website.",
        })
                        ...
                        <FormItem>
                          ...
                          <Select onValueChange={field.onChange} defaultValue={field.value}>
                            ...
                            <SelectContent>
                              ...
                              <SelectItem value="cameras-drones">Cameras & Drones</SelectItem>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea placeholder="SEO description for search engines" rows={3} {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Compare Price (PKR)</FormLabel>
                        <FormControl>
                          <Input
                            type="number"
                            placeholder="0"
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                        <div className="space-y-0.5">
                          ...
                          <div className="text-sm text-muted-foreground">Track inventory for this product</div>
                        </div>
                        <FormControl>
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                        <div className="space-y-0.5">
                          ...
                          <div className="text-sm text-muted-foreground">Make product visible to customers</div>
                        </div>
                        <FormControl>
                          <Switch checked={field.value} onCheckedChange={field.onChange} />
                        </FormControl>
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                        <div className="space-y-0.5">
                          ...
                          <div className="text-sm text-muted-foreground">Show in featured products section</div>
                        </div>
                        <FormControl>
                          <Switch checked={field.value} onCheckedChange={field.onChange} />
                        </FormControl>
